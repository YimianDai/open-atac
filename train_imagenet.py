...
from model import ResNet50_v1bATAC
...
def parse_args():
    ...
    parser.add_argument('--r', type=int, default=4, help='channel reduction ratio')
    parser.add_argument('--act-type', type=str, default='ChaATAC',
                        help='ChaATAC')
    parser.add_argument('--act-layers', type=int, default=2, help='act layers')
    ...
    # parser.add_argument('--rec-train', type=str, default='~/.mxnet/datasets/imagenet/rec/val.rec',
    #                     help='the training data')
    # parser.add_argument('--rec-train-idx', type=str, default='~/.mxnet/datasets/imagenet/rec/val.idx',
    #                     help='the index of training data')
